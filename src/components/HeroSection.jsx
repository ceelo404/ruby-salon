    ...
    <section className="hero-section">
      ...
      <div className="content-card">
        <div className="card-content">
          ...
          <p>With decades of experience, Ruby Hair Salon offers a curated range of services, including precision cuts, bespoke coloring, and transformative styling, blending cutting-edge techniques with a welcoming atmosphere to deliver a personalized experience that elevates your individual beauty.</p>
          <div>
