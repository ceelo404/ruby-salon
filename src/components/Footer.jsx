...
const FacebookIcon = () => (
  <svg viewBox="0 0 512 512" width="20" height="20" fill="#ffffff">
    <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/>
  </svg>
);

// Icon component for X (formerly Twitter)
const XIcon = () => (
  <svg viewBox="0 0 512 512" width="20" height="20" fill="#ffffff">
...
const InstagramIcon = () => (
  <svg viewBox="0 0 448 512" width="20" height="20" fill="#ffffff">
...
const Footer = ({ onFindUsClick, onHoursClick }) => {
    ...
    <footer>
      <div className="footer-content">
        <p>
          ...
          Phone: <a href="tel:+14043893114" style={{ color: 'rgba(255,255,255,0.7)' }} title="Call Ruby Hair Salon directly">
            (404) 389-3114
          </a> |&nbsp;
          <a id="footer-hours-link" href="#" onClick={(e) => handleLinkClick(e, onHoursClick)} style={{ color: 'rgba(255,255,255,0.7)' }} title="View Ruby Hair Salon's operating hours">
            Our Hours
          </a>
        </p>
        ...
        <div className="copyright-social-container">
          <div className="social-icons">
            {/* Icons are now in the order: Instagram, Facebook, X */}
            ...
            <a href="https://www.facebook.com/people/Ruby-Hair-Salon/61579120356233/" aria-label="Follow Ruby Hair Salon on Facebook" target="_blank" rel="noopener noreferrer" title="Connect with Ruby Hair Salon on Facebook">
              <FacebookIcon />
            </a>
